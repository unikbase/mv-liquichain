...
public class CreateAddress extends Script {
    private static final Logger LOG = LoggerFactory.getLogger(CreateAddress.class);
    ...
    public void execute(Map<String, Object> parameters) throws BusinessException {
        ...
        try {
            ...
            LOG.info("isDefault: {}", address.getIsDefault());
