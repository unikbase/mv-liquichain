...
const createAddressForm = (container) => {
	const html = `<form id='createAddress-form'>
		...
		<div id='createAddress-notes-form-field'>
			<label for='notes'>notes</label>
			<input type='text' id='createAddress-notes-param' name='notes'/>
		</div>
		<div id='createAddress-isDefault-form-field'>
			<label for='isDefault'>isDefault</label>
			<input type='text' id='createAddress-isDefault-param' name='isDefault'/>
		</div>
	...
	const notes = container.querySelector('#createAddress-notes-param');
	const isDefault = container.querySelector('#createAddress-isDefault-param');
	...
	container.querySelector('#createAddress-form button').onclick = () => {
		const params = {
			...
			isDefault : isDefault.value !== "" ? isDefault.value : undefined
		};
