...
const updateAddressForm = (container) => {
	const html = `<form id='updateAddress-form'>
		...
		<div id='updateAddress-notes-form-field'>
			<label for='notes'>notes</label>
			<input type='text' id='updateAddress-notes-param' name='notes'/>
		</div>
		<div id='updateAddress-isDefault-form-field'>
			<label for='isDefault'>isDefault</label>
			<input type='text' id='updateAddress-isDefault-param' name='isDefault'/>
		</div>
	...
	const notes = container.querySelector('#updateAddress-notes-param');
	const isDefault = container.querySelector('#updateAddress-isDefault-param');
